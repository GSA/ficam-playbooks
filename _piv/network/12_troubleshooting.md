...
<div class="usa-accordion" aria-multiselectable="true">
  ...
  <div id="m-a4" class="usa-accordion__content usa-prose">
    ...
    <ol type="1">
      ...
      <li>Lastly, you will need to allow outbound access over port TCP 80 from each domain controller to each of the CRL, OCSP, and AIA distribution points listed in the certificates in the path. For more information, see the Certification Path Discovery and Validation (PDVal) playbook. [LINK TO  PDVAL PLAYBOOK WHEN IT IS COMPLETE]</li>
    </ol>
