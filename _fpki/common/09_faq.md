...
{% include alert-warning.html heading="Heads-up! " content="The Federal PKI Management Authority has completed the revocation of the certificates issued by the Federal Common Policy CA.  If you are encountering any issues, please review our solutions for Windows <a href=\"../common/faq/#how-do-i-configure-my-unmanaged-windows-system-to-trust-the-new-federal-common-policy-ca-g2\" target=\"_blank\">Windows</a> and <a href=\"../common/faq/#how-do-i-configure-my-unmanaged-macos-device-to-trust-the-new-federal-common-policy-ca-g2\" target=\"_blank\">macOS</a>.  If these solutions do not address your problem, please escalate to your agency or component help desk for additional support.  If you support an agency or component help desk and need support, please contact fpkirootupdate@gsa.gov." %} 
